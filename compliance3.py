...
class Pipeline:
    class Valves(BaseModel):
        ...
        KNOWLEDGE_BASE_C3: str = ""
        BEDROCK_MODEL_ID_C3: str = "amazon.nova-lite-v1:0"  
        DEFAULT_NUMBER_OF_RESULTS_C3: int = 10            
        DEFAULT_PROMPT_TEMPLATE_C3: str = ""              
    ...
    def __init__(self):
        ...
        self.valves = self.Valves(
            ...
            DEFAULT_PROMPT_TEMPLATE_C3=os.getenv(
                "DEFAULT_PROMPT_TEMPLATE_C3",
...
Pergunta do Usuário: <question> $query$ </question>"""
    ...
    def pipe(
        ...
        try:
            number_of_results = body.get("numberOfResults", self.valves.DEFAULT_NUMBER_OF_RESULTS_C3)
            prompt_template = body.get("promptTemplate", self.valves.DEFAULT_PROMPT_TEMPLATE_C3)
            ...
            payload = {
                ...
                "retrieveAndGenerateConfiguration": {
                    ...
                    "knowledgeBaseConfiguration": {
                        "knowledgeBaseId": self.valves.KNOWLEDGE_BASE_C3,
                        "modelArn": f"arn:aws:bedrock:{self.valves.AWS_REGION_NAME_ANIMA}::foundation-model/{self.valves.BEDROCK_MODEL_ID_C3}",
