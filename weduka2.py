...
class Pipeline:
    class Valves(BaseModel):
        ...
        KNOWLEDGE_BASE_W2: str = "ITHFWZRFDI"
        BEDROCK_MODEL_ID_W2: str = "amazon.nova-lite-v1:0"  
        DEFAULT_NUMBER_OF_RESULTS_W2: int = 10            
        DEFAULT_PROMPT_TEMPLATE_W2: str = ""              
    ...
    def __init__(self):
        ...
        self.valves = self.Valves(
            ...
            KNOWLEDGE_BASE_W2="XANPHABEXM",
            BEDROCK_MODEL_ID_W2="amazon.nova-lite-v1:0",
            DEFAULT_NUMBER_OF_RESULTS_W2=int(os.getenv("DEFAULT_NUMBER_OF_RESULTS_W2", 10)),
            DEFAULT_PROMPT_TEMPLATE_W2=os.getenv(
                "DEFAULT_PROMPT_TEMPLATE_W2",
...
Pergunta do Usuário: <question> $query$ </question>"""
    ...
    def pipe(
        ...
        try:
            number_of_results = body.get("numberOfResults", self.valves.DEFAULT_NUMBER_OF_RESULTS_W2)
            prompt_template = body.get("promptTemplate", self.valves.DEFAULT_PROMPT_TEMPLATE_W2)
            ...
            payload = {
                ...
                "retrieveAndGenerateConfiguration": {
                    ...
                    "knowledgeBaseConfiguration": {
                        "knowledgeBaseId": self.valves.KNOWLEDGE_BASE_W2,
                        "modelArn": f"arn:aws:bedrock:{self.valves.AWS_REGION_NAME_ANIMA}::foundation-model/{self.valves.BEDROCK_MODEL_ID_W2}",
